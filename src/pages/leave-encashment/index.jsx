...
function index() {
  ...
  return (
    <div>
      <h2 className={styles.header_text}>Leave Encashment Policy</h2>
      ...
      >
        <div className={styles.terms_container}>
          <iframe
            src={`https://tradebrains-fingrad-staging.s3.ap-south-1.amazonaws.com/Policies/Leave+Encashment+Policy+-+2025.pdf`}
            title="PDF Document"
            width="100%"
            height="800px"
            style={{ border: "none" }}
